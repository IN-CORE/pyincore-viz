...
class TableDatasetListMap:
    ...
    def __init__(self):
        self.map = ipylft.Map(center=(0, 0), zoom=12, basemap=ipylft.basemaps.Stadia.StamenToner, scroll_wheel_zoom=True)
    ...
    def create_basemap_ipylft(self, geo_dataframe, title_list):
        ...
        self.map = ipylft.Map(center=(cen_x, cen_y), zoom=12,
                              basemap=ipylft.basemaps.Stadia.StamenToner, scroll_wheel_zoom=True)
